...
lunch aosp_tblte-userdebug && make aex -j$(nproc --all) # Make TBLTE
...
cd /home/shizzle2889/android/AEX # Set Base Directory
lunch aosp_trlte-userdebug && make -j$(nproc --all) aex # Make TRLTE
...
cd /home/shizzle2889/android/AEX # Set Base Directory
lunch aosp_trlteduos-userdebug && make -j$(nproc --all) aex # Make TRLTEDuos
